    ...
    <div class="sl-sideleft">
        ...
        <div class="sl-sideleft-menu">
            ...
            <ul class="sl-menu-sub nav flex-column">
                ...
                <li class="nav-item"><a href="{{ route('admin.roles.create') }}" class="nav-link">Create Role</a></li>
            ...
            <ul class="sl-menu-sub nav flex-column">
                ...
                <li class="nav-item"><a href="form-validation.html" class="nav-link">Form Validation</a>
                </li>
